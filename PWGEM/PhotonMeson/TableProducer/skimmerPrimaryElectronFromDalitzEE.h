...
/// \file skimmerPrimaryElectronFromDalitzEE.h
...
using MyTracks = o2::soa::Join<o2::aod::Tracks, o2::aod::TracksExtra, o2::aod::TracksDCA, o2::aod::TracksCov,
                               o2::aod::pidTPCFullEl, o2::aod::pidTPCFullPi, o2::aod::pidTPCFullKa, o2::aod::pidTPCFullPr,
                               o2::aod::pidTOFFullEl, o2::aod::pidTOFFullPi, o2::aod::pidTOFFullKa, o2::aod::pidTOFFullPr,
                               o2::aod::pidTOFbeta, o2::aod::TOFSignal, o2::aod::TOFEvTime>;
...
template <o2::soa::is_table TEMPrimaryElectronsFromDalitz, o2::soa::is_table TEMPrimaryElectronsDeDxMC, o2::soa::is_table TV0PhotonsKF>
struct skimmerPrimaryElectronFromDalitzEE {
  ...
  bool checkTrack(TCollision const& collision, TTrack const& track)
  {
    if constexpr (isMC) {
      ...
      if (storeOnlyTrueElectronMC) {
        const auto& mcParticle = track.template mcParticle_as<o2::aod::McParticles>();
  ...
  void fillPairInfo(TCollision const& collision, TTracks1 const& tracks1, TTracks2 const& tracks2)
  {
    if constexpr (pairtype == 0) { // ULS
      for (const auto& [t1, t2] : combinations(o2::soa::CombinationsFullIndexPolicy(tracks1, tracks2))) {
  ...
  o2::framework::Partition<MyTracks> posTracks = o2::aod::track::signed1Pt > 0.f;
  o2::framework::Partition<MyTracks> negTracks = o2::aod::track::signed1Pt < 0.f;
  ...
  // ---------- for data ----------
  void processRec(MyCollisions const& collisions, MyBCs const& bcs, MyTracks const& tracks, TV0PhotonsKF const& v0photons, o2::aod::TrackAssoc const& trackIndices)
  {
  ...
  o2::framework::Partition<MyTracksMC> posTracksMC = o2::aod::track::signed1Pt > 0.f;
  o2::framework::Partition<MyTracksMC> negTracksMC = o2::aod::track::signed1Pt < 0.f;
  // ---------- for MC ----------
  void processMC(MyCollisionsMC const& collisions, o2::aod::McCollisions const&, MyBCs const& bcs, MyTracksMC const& tracks, TV0PhotonsKF const& v0photons, o2::aod::TrackAssoc const& trackIndices, o2::aod::McParticles const&)
  {
