...
using collisionEvSelIt = o2::aod::Collision; // o2::soa::Filtered<o2::aod::Collisions>::iterator;
...
struct EventMixVec {
  ...
  Photon* getPhoton(int iEvt, int iGamma)
  {
...
struct Pi0QCTask {
  ...
  // selected collision ids
  // std::vector<int> vecSelectedCollID;
  ...
  void processCollisions(o2::soa::Join<o2::aod::Collisions, o2::aod::EvSels>::iterator const& collision, selectedClusters const& clusters)
  {
    ...
    if (mVertexCut > 0 && TMath::Abs(collision.posZ()) > mVertexCut) {
